...
8. **Asides addressed to Claude aren't entry content.** A parenthetical Ash aims at Claude while dictating ("that's the one near the park," "you remember") is transcription context: use it to resolve the reference, then leave it out of the entry. Asides within his own prose stay verbatim under rule #3. When a parenthetical could be either, ask.
</important>
